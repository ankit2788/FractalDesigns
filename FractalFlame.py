...
configFolder = os.path.join(path, "Configs/Flames")
...
Flame.applyConfiguration(configPath=os.path.join(configFolder, "Test1.ini"))
...
Flame.applyConfiguration(configPath=os.path.join(configFolder, "Test3.ini"))
...
Flame.draw()
Flame.save(path=os.path.join(savePath, "Flame1_small.png"))
# Flame.save(path="/Users/ankitgupta/Documents/git/anks/github_page/data/pics/2020/01/Flame1_small.png")

Flame = FractalFlame(name="Random", NbSamples=100, NbIters=1000, xres=550, yres=310)
Flame.applyConfiguration(configPath=os.path.join(configFolder, "Test2.ini"))
...
Flame.draw()
Flame.save(path=os.path.join(savePath, "Flame2_small.png"))
...
Flame.applyConfiguration(configPath=os.path.join(configFolder, "Test4.ini"))
