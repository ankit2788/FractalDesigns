...
Fern.applyConfiguration(configPath= os.path.join(configFolder, "Fern.ini"))
# Fern.applyConfiguration(configPath= "/Users/ankitgupta/Documents/STUDY/git/anks/FractalDynamics/FractalDesigns/Configs/IFS/Fern.ini")
Fern.draw()
...
Dentrite.applyConfiguration(configPath= os.path.join(configFolder, "Dentrite.ini"))
...
Sierpinski.applyConfiguration(configPath= os.path.join(configFolder, "Sierpinski2.ini"))
...
Koch.applyConfiguration(configPath= os.path.join(configFolder, "Koch.ini"))
...
random1.applyConfiguration(configPath= os.path.join(configFolder, "Random1.ini"))
...
random2.applyConfiguration(configPath= os.path.join(configFolder, "Random2.ini"))
...
random3.applyConfiguration(configPath= os.path.join(configFolder, "Random3.ini"))
